...
void SS_ig_objective_init_function(	obj_type 			*SS_objective,
	...
	for (int iss = 0; iss < gv.len_ss; iss++){
		...
		if      (strcmp( gv.SS_list[iss], "bi")  == 0 ){
			...
			SS_objective[iss]  = obj_ig_ma; 		}
		else if (strcmp( gv.SS_list[iss], "chl") == 0){
			SS_objective[iss]  = obj_ig_chl; 		}
		else if (strcmp( gv.SS_list[iss], "ctd") == 0){
			SS_objective[iss]  = obj_ig_ctd; 		}
		else if (strcmp( gv.SS_list[iss], "car") == 0){
			SS_objective[iss]  = obj_ig_car; 		}
		else if (strcmp( gv.SS_list[iss], "ta") == 0){
			SS_objective[iss]  = obj_ig_ta; 		}
		else if (strcmp( gv.SS_list[iss], "zoi") == 0){
			SS_objective[iss]  = obj_ig_zoi; 		}
		else{
