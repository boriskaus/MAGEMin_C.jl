...
void print_help(	global_variable gv	){
	...
	printf("\n");
	printf(" * 'mp': metapelite, 'mb': metabasite, 'ig': igneous H18->G23, 'igd': igneous T21->G23, 'alk': igneous alkaline, 'um': ultramafic\n");
	printf("\n");
...
bulk_info retrieve_bulk_PT(				global_variable      gv,
	...
	if (gv.verbose == 1){	
		...
		if (gv.EM_database 		== 1){
			...
			printf("  - Database                  : Igneous (Holland et al., 2018 -> Green et al., 2023), enhanced\n"	);
		}
